...
Horse population data were sourced from the [Government of Canada's Open Data website](http://open.canada.ca/en/open-data) (Government of Canada, 2017a and Government of Canada, 2017b). [@horses1, @horses2]
...
```{r horse-pops-plot, out.width="50%", fig.cap="Horse populations for all provinces in Canada from 1906 - 1972"}
...
knitr::kable(horses_sd_table, caption = "Table of standard deviations")
```
...
```{r horse-sd-plot, out.width="50%", fig.cap = "Horse populations for the province with the largest standard deviation"}
